      ...
      <div className="px-10 py-8">
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <button className="bg-[#272727] w-[174px] px-4 py-1 rounded-full font-medium cursor-pointer active:bg-gray-200 active:text-black">
              Manage Videos
            </button>
          </div>
          <div className="flex flex-col items-center mt-16">
            ...
            <button className="bg-white text-black mt-4 px-5 py-1 rounded-full font-medium cursor-pointer active:bg-gray-900 active:text-white">
              Create
            </button>
          </div>
        </div>
